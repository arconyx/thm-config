# Not currently imported by configuration.nix but let for reference

{ config, pkgs, ... }:

{
  # Enable OpenGL
  hardware.graphics.enable = true; # also enabled in common/display.nix
  ...
  environment.variables = {
    # Firefox hardware acceleration tweaks
